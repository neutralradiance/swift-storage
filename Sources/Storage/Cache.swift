    ...
    public var wrappedValue: [Value] {
        get {
            do {
                ...
                debugPrint(Error<Value>.read(description: error.localizedDescription).localizedDescription)
            }
            return []
        }
        nonmutating set {
            do {
                ...
                debugPrint(Error<Value>.write(description: error.localizedDescription).localizedDescription)
            }
        }
    }
...
extension Cache {
    ...
    /// An automatically determined name for the cache folder based on the associated type `Value`.
    public static var key: String { String(describing: Value.self) }
